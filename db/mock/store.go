...
// Source: github.com/Dev-El-badry/wallet-system/db/sqlc (interfaces: Store)
...
func (m *MockStore) GetAccountForUpdated(arg0 context.Context, arg1 int64) (db.Accounts, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccounts(arg0 context.Context, arg1 db.GetAccountsParams) ([]db.Accounts, error) {
	m.ctrl.T.Helper()
